...
class _AnitectionClient implements AnitectionClient {
  ...
  Future<PagingData<Model<TimelineAttributes>>> getTimelines(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PagingData<Model<TimelineAttributes>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PagingData<Model<TimelineAttributes>>.fromJson(
      _result.data!,
      (json) => Model<TimelineAttributes>.fromJson(
        json as Map<String, dynamic>,
        (json) => TimelineAttributes.fromJson(json as Map<String, dynamic>),
      ),
    );
    return value;
  }
  ...
  Future<PagingData<Model<MessageAttributes>>> getMessages(
    ...
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'filters[institution][id][$eq]': institutionId
    };
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> createMessage(Map<String, dynamic> request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
